...
**Related audits:** [`COMPLEXITY_CUT_REVIEW.md`](./COMPLEXITY_CUT_REVIEW.md) · [`LONGEVITY_100H.md`](./LONGEVITY_100H.md) · [`FEATURE_GATE.md`](./FEATURE_GATE.md) · [`design/VERTICAL_SLICE_GATE.md`](./design/VERTICAL_SLICE_GATE.md) — **NOT CLEARED** until external playtest · [`design/WHOLE_GAME_COHESION_AUDIT.md`](./design/WHOLE_GAME_COHESION_AUDIT.md) — honest front-to-end iconic gaps (2026-08-19)
