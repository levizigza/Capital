...
5. **No map widen** — pad is a local Canvas; Harbor / Cove / Paycheck / Credit stay the only travel spine.
6. **Soundtrack stays** — organ stingers on gallery; beds unchanged.
