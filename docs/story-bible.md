...
**Also see:** [CAPITAL_DESIGN_BIBLE.md](./CAPITAL_DESIGN_BIBLE.md) — living design constitution · [player-fantasy-and-loop.md](./player-fantasy-and-loop.md) — fantasy, core loop, goals/fail, and the **navigability law** (never soft-lock a screen).
...
| **Series leads** | **Cashwell** · **Cashmere** · **Peso Pedro** · **Fortuna Fernanda** · **Billionaire Bao** · **Jade Fortune** · **Sultan Stacks** · **Dinar Dahlia** · **Mansa Moneybaggs** · **Kandake Kash** · **Moneybagg Bro** · **Mula Mami** | Faces of Cashwell Capital — Memory Courtyard cast by the Plinth. Name living money with style. Never steal Piggy presence / Coin Bag pointing on the signature loop. |
