# Capital quality north-star audit
...
**Related audit on branch only:** `docs/design/FAKE_MECHANICS_AUDIT.md` on `cursor/fake-mechanics-audit-2fc5` (not present on this tree) — quiz gates, silent XP/skillStats, ritual streaks flagged as fake play.
