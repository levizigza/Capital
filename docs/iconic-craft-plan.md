...
**Shipped (Pillar 13 — partial):** Harbor Ashore UI law — Talk → Carpet → Cove; Outfitter-card onboarding demoted. **Not iconic.** 2026-08-17: removed title CTA bob soft-lock; walk pad on desktop; tap-to-claim rings. Guarded by `onboardingNoAhead.test.ts` + harbor-tutorial e2e + cast-select real-click path.
...
| 13 | Onboarding | **Gap** — boot soft-lock fixed in flight; not iconic until cold human Ashore→Cove | 2026-08-17 | Title CTA bob removed; walk pad + tap rings; honest status in harbor-ashore.md |
...
**Last shipped:** Tutorial honesty pass — title CTA clickable again; Ashore walk failsafe. Status remains **Gap** until cold human Ashore→Cove retell.  
