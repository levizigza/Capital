...
**Honest live board:** [full-game-craft-board.md](./full-game-craft-board.md) — overall **66%** after Pass C (map + fantasy + Take hush). Do not treat the historical table below as current iconic proof.
