...
**Honest live board:** [full-game-craft-board.md](./full-game-craft-board.md) — overall **68%** after Pass D (map + fantasy + Take hush + Soft Beat shore). Do not treat the historical table below as current iconic proof.
