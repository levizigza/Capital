...
| 10 | Art direction | playable → iconic | 2026-08-04 | Ledger Bank brass columns + teller glass + dial-spin / Teller lower-third (iter 18). Next: Tower/Keep architecture parity |
...
**Last shipped:** Whole-game craft **iter 18 — Harbor Ledger Bank interior** (architecture + dial-spin/stamp-press + Teller lower-third).  

**Craft sequence complete (0–17 pillars).** Next deepen: Payroll Tower · Interest Keep interiors · day-2 echo · share thumbnail — do not widen the map.
