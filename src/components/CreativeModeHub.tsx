  ...
  const handleGameComplete = (score: number, additionalData?: any) => {
    if (selectedGame) {
      ...
      const messages = [
        ...
        '🌺 A new bloom appears in your garden!',
        '🌳 Your financial tree reaches higher!',
        '🌸 Beautiful growth in your garden!',
        '🌿 Your garden flourishes with knowledge!'
      ]
      const randomMessage = messages[Math.floor(Math.random() * messages.length)]
      
      toast.success(randomMessage, {
        description: `+${Math.floor(score * 0.5) + 50} XP, +${Math.floor(score * 0.3) + 25} coins earned`
      })
    }
  }
