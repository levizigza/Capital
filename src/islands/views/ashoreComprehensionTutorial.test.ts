...
describe("Ashore FTUE-7 interactive teach", () => {
  ...
  it("boots title → cast → teach|skip → carpet and passes the Voyager", () => {
    ...
    expect(app).toMatch(/shouldSkipAshoreTeach/);
    expect(app).toMatch(/setBootPhase\(shouldSkipAshoreTeach/);
