...
export const ISLAND_THEMES: Record<string, IslandTheme> = {
  ...
  /** Island 1 — Coincraft Cove chapter (first painting — not Harbor twin) */
  coincraft_cove: {
    id: "coincraft_cove",
    name: "Coincraft Cove",
    ...
    background: "linear-gradient(180deg, #38bdf8 0%, #4ade80 40%, #fcd34d 100%)",
    accent: "#ea580c",
    accentMuted: "#fdba74",
    fontFamily: "'Fraunces', 'Georgia', serif",
    mood: "🏝️ Solarpunk · canopy lagoon · earn · choose",
    mapPinShape: "round",
    complexity: "easy",
    genre: "exploration",
    fortuneBlurb: "Solarpunk lagoon — earn coins, then choose save or spend with the Canopy Craft Guild.",
  },
  ...
  signal_city: {
    ...
    accentMuted: "#1a8c3a",
    fontFamily: "'Courier New', monospace",
    mood: "🟢 Biopunk · gene reef · FUEL",
    mapPinShape: "diamond",
    complexity: "medium",
    genre: "party",
    fortuneBlurb: "Biopunk reef — steer living capital through inflation spikes and gene markets.",
  },
  ...
  venture_foundry: {
    ...
    mood: "🌆 Cyberpunk · corp sprawl · STAGE",
    mapPinShape: "hex",
    complexity: "hard",
    genre: "party",
    fortuneBlurb: "Cyberpunk sprawl — neon race toward retirement; dodge corp debt traps.",
  },
  ...
  financial_assets: {
    ...
    mood: "🦊 Post-apoc · scrap karts · LAP",
    mapPinShape: "square",
    complexity: "medium",
    genre: "party",
    fortuneBlurb: "Post-apoc scrap coast — salvage budgets win the race with patched bots.",
  },
  ...
  business_assets: {
    ...
    accentMuted: "#fde68a",
    fontFamily: "'Fraunces', Georgia, serif",
    mood: "🚀 Spacefaring · orbital keep · gems",
    mapPinShape: "hex",
    complexity: "medium",
    genre: "party",
  ...
  credit_kingdom: {
    ...
    mood: "🗿 Post-apoc · credit scars · ruins",
    mapPinShape: "diamond",
    complexity: "hard",
    genre: "party",
    fortuneBlurb: "Post-apoc ordeal — recover credit-history artifacts from collapsed ruins.",
  },
  ...
  future_shores: {
    ...
    accentMuted: "#c4b5fd",
    fontFamily: "'Fraunces', Georgia, serif",
    mood: "🌞 Solarpunk · sky gardens · weather",
    mapPinShape: "round",
    complexity: "hard",
    genre: "party",
    fortuneBlurb: "Solarpunk sky gardens — market weather reshapes renewable portfolios.",
  },
  digital_assets: {
    id: "digital_assets",
    ...
    mood: "🤖 AI Future · terminal minds · tokens",
    mapPinShape: "hex",
    complexity: "hard",
    genre: "simulation",
    fortuneBlurb: "AI Future undercity — digital assets traded beside companion machines.",
  },
  real_estate: {
    id: "real_estate",
    ...
    mood: "🛰️ Spacefaring · colony deeds · bids",
    mapPinShape: "diamond",
    complexity: "medium",
    genre: "strategy",
    fortuneBlurb: "Space colony lots — auction habitat deeds across the void.",
  },
  intangibles: {
    id: "intangibles",
    ...
    mood: "🧬 Posthuman · mind patents · archive",
    mapPinShape: "round",
    complexity: "medium",
    genre: "puzzle",
    fortuneBlurb: "Posthuman cliffs — patents of self, uploaded minds, intangible capital.",
  },
  starter_key_cove: {
    id: "starter_key_cove",
    name: "Key Cove",
    ...
    animationStyle: "era-1990s",
    skinClass: "island-theme-lowpoly",
    background: "linear-gradient(180deg, #fde68a 0%, #fdba74 45%, #38bdf8 100%)",
    accent: "#ca8a04",
    accentMuted: "#fef08a",
    fontFamily: "'Fraunces', Georgia, serif",
    mood: "🌱 Solarpunk · starter cay · keys",
    mapPinShape: "diamond",
    complexity: "easy",
    genre: "exploration",
    fortuneBlurb: "Solarpunk starter cay — practice keys with quiet canopy bots.",
  },
  demo: {
    id: "demo",
    name: "Demo Vault",
    ...
    mood: "🧪 Biopunk · chalk lab · sandbox",
    mapPinShape: "square",
    complexity: "easy",
    genre: "arcade",
    fortuneBlurb: "Biopunk sandbox lab — try anything living.",
  },
};
