...
export const ISLAND_THEMES: Record<string, IslandTheme> = {
  ...
  coincraft_cove: {
    ...
    accentMuted: "#fdba74",
    fontFamily: "'Fraunces', 'Georgia', serif",
    mood: "🏝️ tropical lagoon · first painting · earn · choose",
    mapPinShape: "round",
    complexity: "easy",
    genre: "exploration",
    fortuneBlurb: "Earn coins, then choose save or spend — Captain Penny’s lagoon.",
  },
