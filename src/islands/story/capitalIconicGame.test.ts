...
describe("iconic whole-game criteria contracts", () => {
  ...
  it("names Credit Spiral lock with Paycheck Change gate", () => {
    const locked = {
      id: "credit_kingdom",
      name: "Credit Kingdom",
      requiredItems: [],
