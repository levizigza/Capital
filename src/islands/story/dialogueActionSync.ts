...
export const GUIDED_VISUAL_BEATS: Record<string, GuidedVisualBeats> = {
  meet_guide: {
    ...
    bagTip: "Piggy’s waving — talk to her!",
    pulseHotspot: "guide",
  },
  walk_outfitter: {
    keeperEmote: "point",
    keeperBubbleWhenNear: "Piggy Penny: Become YOU first — the Outfitter door is ahead. Coin Bag’s hopping there!",
    bagTip: "Outfitter door!",
  ...
  first_island: {
    ...
    keeperEmote: "wave",
    keeperBubbleWhenNear: "Piggy Penny: Harbor is yours. I’ll wave when you come home.",
    bagTip: "Explore!",
  },
};
