...
export const HUB_GUIDED_STEPS: Array<{
...
}> = [
  {
    id: "meet_guide",
    storyBeat: "you",
    coach: "Walk to Piggy Penny — she waves at you!",
    guideLine: "Piggy Penny: Welcome ashore! I’m your Harbor Keeper. Follow me — one step at a time.",
    verb: "Walk · Talk",
    highlight: "guide",
  },
  {
    id: "walk_outfitter",
    storyBeat: "you",
    coach: "Walk to the Outfitter (front center).",
    guideLine: "Piggy Penny: First — become YOU. The Outfitter is straight ahead.",
    verb: "Walk",
    highlight: "outfitter",
  },
  {
    id: "become_you",
    storyBeat: "you",
    coach: "Go inside the Outfitter and pick your look.",
    guideLine: "Piggy Penny: Pick a Money Mascot look. You’re still you — just clearer!",
    verb: "Enter · Choose",
    highlight: "outfitter",
  },
  {
    id: "tiny_spend",
    storyBeat: "need",
    coach: "Visit the Capsule Stall — coins can buy helpful things.",
  ...
  },
  {
    ...
    storyBeat: "need",
    coach: "Optional: Practice board — or skip to the Carpet Dock.",
  ...
  },
  {
    id: "done",
    storyBeat: "change",
    coach: "Harbor is yours. Islands wait when you’re ready.",
